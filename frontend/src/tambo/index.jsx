...
/**
 * TAMBO SDK MOCK - HACKATHON STABILITY
 * 
 * The real SDK (@tambo-ai/react) requires Node.js polyfills (ts-node) that
 * cause Vite to crash with a blank page. 
 * 
 * This file replaces the SDK internals with a robust simulation
 * that mimics the exact API surface of the real SDK.
 */
